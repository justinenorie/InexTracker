...
<template>
    ...
    >
        ...
        >
            <div
                class="mx-auto flex max-w-7xl items-center justify-between p-4 px-6"
            >
        ...
        <section class="relative overflow-hidden pt-16 pb-20 lg:pt-32 lg:pb-40">
            ...
            <div class="mx-auto max-w-7xl px-6 text-center">
                ...
                >
                    The simple, intuitive way to track your income, manage
                    expenses, and visualize your financial growth. InexTracker
                    helps you master your money.
                </p>
            ...
            <div class="mx-auto max-w-7xl px-6">
                <div class="mb-16 text-center">
                    ...
                    <p class="mt-4 text-muted-foreground">
                        Powerful features to give you total clarity on your
                        spending habits.
                    </p>
                </div>
                ...
                >
                    <div class="max-w-xl">
                        ...
                        <p class="mt-6 text-lg text-muted-foreground">
                            We built InexTracker because we were tired of
                            complex spreadsheets and confusing banking apps. Our
                            mission is to provide a clean, visual platform that
                            empowers individuals to achieve their financial
                            goals.
                        </p>
                        <div class="mt-8 space-y-4">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-medium"
                                    >Bank-grade encryption for your peace of
                                    mind</span
                                >
                            </div>
                            <div class="flex items-center gap-3">
        ...
        <section class="py-20">
            <div class="mx-auto max-w-5xl px-6">
                ...
                >
                    ...
                    >
                        Join thousands of people who have already improved their
                        financial habits with InexTracker.
                    </p>
                    <div
                        class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row"
                    >
            ...
            <div class="mx-auto max-w-7xl px-6">
                <div class="grid gap-12 md:grid-cols-4 lg:grid-cols-5">
                    <div class="md:col-span-2 lg:col-span-2">
                        ...
                        >
                            Empowering you to manage your finances with ease,
                    ...
                    <div>
                        <h4
                            class="mb-4 text-sm font-bold tracking-wider uppercase"
                        >
                            Product
                        </h4>
                        <ul
                            class="space-y-3 text-sm font-medium text-muted-foreground"
                        >
                            <li>
                                <a
                                    href="#features"
                ...
                >
                    <p>
                        © {{ new Date().getFullYear() }} InexTracker. Built with
                        passion for better financial health.
                    </p>
                </div>
            </div>
        </footer>
