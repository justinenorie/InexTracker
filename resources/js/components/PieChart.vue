  ...
  <Card class="flex flex-col">
    ...
    <CardContent class="flex-1 pb-0">
      <div
        ...
        class="flex h-[200px] items-center justify-center text-sm text-muted-foreground italic"
      >
    ...
    <CardFooter class="pt-0">
      <div class="w-full text-center text-xs text-muted-foreground">
        Showing the distribution of your
        <strong>{{ activeType }}s</strong> across different categories for the
        selected period.
      </div>
    </CardFooter>
  </Card>
